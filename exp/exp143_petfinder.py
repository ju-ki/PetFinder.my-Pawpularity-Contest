...
if Config.DEBUG:
    ...
    dataset = TrainDataset(train_df, transform=get_transforms(phase="train"))
    plot_imgs(dataset)
...
oof1_df = pd.read_csv("./models/exp143/oof_df.csv")
oof2_df = pd.read_csv("./models/exp143/oof_df1.csv")


# In[26]:


oof_df = pd.concat([oof1_df, oof2_df])
print(get_score(oof_df["Pawpularity"].values, oof_df["preds"].values))


# In[27]:


oof_df.to_csv("./models/exp143/all_oof_df.csv", index=False)
