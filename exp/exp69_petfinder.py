...
def make_simsiam_model():
    ...
    model = SimSiam(resnet, out_dim=512, pred_dim=128)
    model.load_state_dict(torch.load("./models/simsi/new_simsiam_resnet34d_20_model.pth", map_location=torch.device("cpu")))
