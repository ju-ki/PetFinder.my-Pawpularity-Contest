...
oof_df = pd.read_csv("./models/exp142/oof_df.csv")
oof_df1 = pd.read_csv("./models/exp142/oof_df1.csv")


# In[28]:


oof_df = pd.concat([oof_df, oof_df1])


# In[30]:


logger.info(get_score(oof_df["Pawpularity"].values, oof_df["preds"].values))


# In[31]:


oof_df.to_csv("./models/exp142/all_oof_df.csv", index=False)
